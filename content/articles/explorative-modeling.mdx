...
<Figure
  ...
  caption="Same training setup, only K varied: XM-1 (no exploration) collapses to a mode-averaged blur; by XM-50 the model recovers a photo close to the ground truth (Gladstone, Ji & Du, 2026, Figure 2, panels f-j)."
/>
