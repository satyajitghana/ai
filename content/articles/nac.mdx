...
<Figure
  ...
  caption="What a worker is given and what is left of it. Three inputs, three outputs, and the transcript that produced the episode is not one of them (Arcee's nac write-up, arcee.ai/blog/nac)."
/>
...
<Figure
  ...
  caption="Thread weaving, drawn: the latest episodes of A and B reach the worker advancing C as context, and C's history ends up holding C1 alone (Arcee's nac write-up, arcee.ai/blog/nac)."
/>
