---
title: "json-render + Jev: generative UI in two model calls"
...
import { IndependentSlots } from "@/components/articles/generative-ui-by-decision/independent-slots"
...
<RepoCard repo="vercel-labs/json-render" />
...
`"use:save"`, the composer calls `structuredClone` on the recipe and writes it into the spec itself. Every prop in
