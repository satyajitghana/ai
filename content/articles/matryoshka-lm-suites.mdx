...
Both halves earn their place. At 200M proxy scale, replacing the fresh embedding with zeros costs +0.54 average validation perplexity; dropping the norm match costs +0.15 more than the full recipe. The complete recipe lands within **0.02 PPL** of the independently trained baseline.
