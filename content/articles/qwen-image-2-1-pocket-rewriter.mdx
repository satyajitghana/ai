...
| quoted strings (g1, g2) | 6 / 6 whole | 6 / 6 whole | 6 / 6 whole | 6 / 6 intact, 2 split across lines |
...
- **The quoted text survives everywhere.** The 9B's two misses on a substring check are
  not corruption. Every character is there, but it lays the strings out itself:
  ...
  ask for. Both students kept each string whole. This probably pulls down the teacher's
  53% verbatim rate on the card as well.
