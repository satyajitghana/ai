...
poster. As of this writing the first render is running, and each pair appears here as
it finishes.
...
The text half of the first is settled for all four rewriters. The rest waits for the
images.
