...
<Callout type="note">
**A size discrepancy worth noting.** Mind Lab's blog describes Macaron-V1-Tall as **50B (35B base + four 3.7B
adapters)**, while the model card and the Hugging Face listing both say **36B** on a `Qwen3.6-35B-A3B` base. The
two accounts disagree about the adapter size. I have used the model card's figures where they conflict, but
neither is independently verifiable.
</Callout>
