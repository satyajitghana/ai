...
Math holds: the 1-bit model keeps ~96% of the full-precision score. But
...
Two months later, PrismML shipped a sequel: [Bonsai 2 27B](/articles/bonsai-2-27b) swaps in a stronger
base model, claims a headline "98.2% of full precision" against gen 1's "~95%," and — for the first
time — reports real numbers on the long-horizon agentic benchmarks this piece's roadmap called out as
the next thing to fix. The size story barely moves; the retention story is more uneven than the
headline number suggests, in a very similar way to the one above.
