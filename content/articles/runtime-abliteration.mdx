...
**Not shown.** Any alpha=0-vs-alpha=1 throughput comparison on the actual MLX runtime. Any measurement of how well a direction estimated on the bf16 base transfers through this model's own quantization-aware training — a gap the repo names itself rather than one this article had to find.
