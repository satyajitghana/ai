---
title: "One call, ten agents, and the answer moves"
...
structural constraint: the options never share a context.
...
<Figure
  ...
  alt="Screenshot of the Jev Swarm web app in Jev Joint mode. A dark 30x30 grid holds four coloured snakes and nine food pellets. A right-hand panel of counters reads: mode Jev Joint, alive 4/10, food 8, latency 409 ms, P50/P95 412/495 ms, questions per call 4, tokens in/out 2610/167, raw conflicts 24, collision deaths 2, override count 14, override rate 2.2%, deadline timeouts 0.8%, expired responses 0, fallback ticks 1, tick 176. Below it, this tick's decisions: S1 straight 98%, S6 straight 62%, S7 straight 56%, S10 straight 80%."
...
published run it is **2.2%**, fourteen overrides across 176 ticks. That is a
real result in the model's favour, published by someone who set up the
measurement so it could have gone the other way.
