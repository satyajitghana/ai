...
description: "Moonshot's Kimi K3 is a 2.8T-parameter, 104B-active open MoE with a 1M-token context — now with weights, code and a 47-page technical report on the table. A first-principles walk through what actually makes it new: Kimi Delta Attention, Attention Residuals, Stable LatentMoE routing 16 of 896 experts with quantile balancing, NoPE, the nine-expert post-training funnel and the reward cliffs behind it, the measured 2.5× scaling-efficiency gain over K2, and where it lands against the frontier."
date: 2026-07-17
updated: 2026-08-24
interest: 5
helpful: 5
...
import { RewardCliffs } from "@/components/articles/kimi-k3/reward-cliffs"
