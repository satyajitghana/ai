...
<Figure
  ...
  caption="The log-linear claim as the lab plots it: reward on a held-out aggregate of reasoning evals — AIME, HLE, GPQA and others — climbing from 0.264 at SFT initialization to 0.356 at release, with every checkpoint close to a straight-line fit. One checkpoint near 6M rollouts dips below the line and is the only visible wobble. (Thinking Machines Lab, Inkling announcement post.)"
/>
