...
<Figure
  ...
  alt="Three photographs in a row. Left, labelled Scene by the source: the weathered timber front of a Feed and Hay store on a dirt street, hay bales stacked under its awning and a flat-bed wagon parked at the boardwalk. Middle, labelled Role: a character sheet of one man in a brown felt hat, grey shirt, braces and tan trousers, shown front, back and in close-up head-and-shoulders against a plain olive backdrop. Right, labelled Object: a four-wheeled wooden hay wagon loaded with bales, a canvas sheet and coiled rope over its box, photographed side-on in a dirt yard."
