...
import { DiskStriping } from "@/components/articles/colibri/disk-striping"

[GLM-5.2](/articles/glm-5-2) is a 744-billion-parameter model — backbone-only; counting
its multi-token-prediction layer it is 753B, which is why some write-ups quote that instead. Loaded the normal way, its
