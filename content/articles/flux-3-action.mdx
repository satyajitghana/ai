...
<Figure
  ...
  caption="BFL's speed–success plot on a B200 in FP8: all three FLUX 3 Action packages sit above and left of the Cosmos 3 Nano to π0.5 front. The x-axis assumes the whole chunk is executed (BFL, FLUX 3 Action report, Figure 1)."
/>
