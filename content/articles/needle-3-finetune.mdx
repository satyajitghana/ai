---
title: "The free fine-tune deletes the confidence head"
...
HTTP range request. Neither Cactus post publishes a raster figure — their charts
are rendered live in the page — so there is nothing to mirror here; the diagrams
above are mine, drawn from the tensor shapes and the `probe_pool` source. The
