...
1.5&times;, because prefill attention is quadratic in the chunk-to-prefix distance and
there is no draft head to amortise it. The upstream `N0` run measures the same thing as
