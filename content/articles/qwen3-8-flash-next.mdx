...
**Not shown.** That 51B of N-gram embedding beats 51B of additional experts — their own fixed-budget study says it doesn't clearly. Whether GR's deleted branch-mixing operator is genuinely free, since the lab shipping the competing answer the same week disagrees. And what any of this does to post-training behaviour beyond the endless-generation note, which is the one place they looked and found something.
