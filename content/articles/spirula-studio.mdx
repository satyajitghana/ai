...
Three identical runs of a 379-image capture: **96.1 AUC@10 every time** in
fp64, and **96.5 / 92.3 / 91.5** in fp32. Noisier *and* 2.7 points worse on
average. The flag to take the speed anyway exists, `--ba-real-coarse float`,
