...
Four details that matter. `revalidate: false` is right, and it is right for an unusual reason:
...
The fourth is easy to miss and it costs money. React's automatic `fetch` memoisation — the thing
