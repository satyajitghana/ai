...
// Local delta from upstream: containers run this as root with a small /dev/shm,
// where Chrome's sandbox refuses to start and large frame buffers abort. See
// VENDORED.md. Harmless everywhere else.
