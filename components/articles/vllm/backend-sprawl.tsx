...
const GROUPS: Group[] = [
  ...
  {
    k: "kv",
    label: "KV transfer connectors · 19",
    colour: C,
    items: [
      "lmcache_connector", "lmcache_mp_connector", "lmcache_integration/",
      "mooncake/", "moriio/", "nixl/", "flexkv_connector", "hf3fs/",
      "offloading/", "offloading_connector", "simple_cpu_offload_connector",
      "multi_connector", "decode_bench_connector", "example_connector",
      "example_hidden_states_connector", "ssm_conv_transfer_utils",
